...
private:
	...
	ValidareGadget& v2;
public:
	Service(Repo<T>& repo1, Repo<V>& repo2, ValidareGadget& valid1, ValidareGadget& valid2) :r1(repo1), r2(repo2), v1(valid1), v2(valid2) { r1 = repo1; r2 = repo2; v1 = valid1; v2 = valid2; };
	~Service();
	void addElem1(T t);
	void addElem2(V v);
	int delElem1(int);
